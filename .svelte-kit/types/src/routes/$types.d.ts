...
type LayoutRouteId = RouteId | "/" | "/(app)/certificates" | "/(app)/edge" | "/(app)/edge/[edgeId]/networks" | "/(app)/edge/[edgeId]/networks/[networkId]/hubs" | "/(app)/firmware" | "/(app)/help" | "/(app)/notifications" | "/(auth)/login" | null
